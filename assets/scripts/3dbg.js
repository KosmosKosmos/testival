...
scene.fog = new THREE.Fog(0x142641, 2, 19);
...
const texture = new THREE.TextureLoader().load("/themes/festivent/assets/textures/texture.jpg");
...
const taper2 = new MOD3.Taper(1.5, 0.1, MOD3.Vector3.Z(false), MOD3.Vector3.Z());
...
//    camera.rotation.z += Math.PI/2 * .0007;
